...
class Systeme
{
    public:
        ...
        //void menuDemanderExamen;
        //void menuSaisirResultatExamen();
    ...
    private:
        ...
        int m_nextIdPatient, m_nextIdConsultation, m_nextIdAntecedent, m_nextIdPrescription, m_nextIdRDV; /**m_nextExamen*/;
